...
/* ---- Macros to get RR, GG, BB, AA values from 0xRRGGBBAA Uint32 */
...
{
	return pixelRGBA(renderer, x, y, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color));
}
...
{
	return hlineRGBA(renderer, x1, x2, y, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color));
}
...
{
	return vlineRGBA(renderer, x, y1, y2, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color));
}
...
{
	return rectangleRGBA(renderer, x1, y1, x2, y2, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color));
}
...
{
	return roundedRectangleRGBA(renderer, x1, y1, x2, y2, rad, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color));
}
...
{
	return roundedBoxRGBA(renderer, x1, y1, x2, y2, rad, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color));
}
...
{
	return boxRGBA(renderer, x1, y1, x2, y2, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color));
}
...
{
	return lineRGBA(renderer, x1, y1, x2, y2, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color));
}
...
{
	return _aalineRGBA(renderer, x1, y1, x2, y2, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color), 1);
}
...
{
	return ellipseRGBA(renderer, x, y, rad, rad, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color));
}
...
{
	return arcRGBA(renderer, x, y, rad, start, end, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color));
}
...
{
	return aaellipseRGBA(renderer, x, y, rad, rad, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color));
}
...
{
	return _ellipseRGBA(renderer, x, y, rx, ry, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color), 0);
}
...
{
	return filledEllipseRGBA(renderer, x, y, rad, rad, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color));
}
...
{
	return aaellipseRGBA(renderer, x, y, rx, ry, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color));
}
...
{
	return _ellipseRGBA(renderer, x, y, rx, ry, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color), 1);
}
...
{
	return _pieRGBA(renderer, x, y, rad, start, end, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color), 0);
}
...
{
	return _pieRGBA(renderer, x, y, rad, start, end, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color), 1);
}
...
{
	return polygonRGBA(renderer, vx, vy, n, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color));
}
...
{
	return aapolygonRGBA(renderer, vx, vy, n, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color));
}
...
{
	return filledPolygonRGBAMT(renderer, vx, vy, n, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color), NULL, NULL);
}
...
{
	return stringRGBA(renderer, x, y, s, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color));
}
...
{
	return bezierRGBA(renderer, vx, vy, n, s, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color));
}
...
{
	return thickLineRGBA(renderer, x1, y1, x2, y2, width, GET_COLOR_R(color), GET_COLOR_G(color), GET_COLOR_B(color), GET_COLOR_A(color));
}
